...
- 주제 범위: 지질 구조와 지각 변동, 암석과 침식, 지형과 지도, 인문·자연 지리, 대기와 날씨, 기후 현상과 자연재해
...
- 핵심 의미: 판구조론
- 사용 맥락: `the theory of plate tectonics`, `tectonic plates`
- 주의: 지각판의 이동으로 대륙 이동, 지진, 화산, 산맥 형성을 설명하는 이론.

### continental drift

- 핵심 의미: 대륙 이동
- 사용 맥락: `continental drift theory`
- 주의: 대륙이 장기간에 걸쳐 움직인다는 생각. 현대에는 판구조론으로 더 넓게 설명됨.
...
- 핵심 의미: 사막화
- 사용 맥락: `desertification in dry regions`
- 주의: 토지 황폐화와 기후·인간 활동으로 건조 지역이 사막처럼 변하는 과정.

### erosion control

- 핵심 의미: 침식 방지
- 사용 맥락: `erosion control measures`
- 주의: 토양과 해안이 물·바람에 깎이는 것을 줄이는 관리 방법.
...
- 핵심 의미: 판게아
- 사용 맥락: `Pangaea began to break apart`
- 주의: 과거 지구의 대륙들이 하나로 모여 있었다고 여겨지는 초대륙.

### Ring of Fire

- 핵심 의미: 환태평양 조산대, 불의 고리
- 사용 맥락: `earthquakes along the Ring of Fire`
- 주의: 태평양 주변의 지진과 화산 활동이 매우 활발한 지대.

### San Andreas Fault

- 핵심 의미: 샌안드레아스 단층
- 사용 맥락: `the San Andreas Fault in California`
- 주의: 캘리포니아의 대표적 단층. 지진 위험 설명에서 자주 등장.
...
- 핵심 의미: 그랜드 캐니언
- 사용 맥락: `erosion in the Grand Canyon`
- 주의: 강의 침식과 지층 노출을 설명하는 대표 사례.

### Gulf Stream

- 핵심 의미: 멕시코만류
- 사용 맥락: `the Gulf Stream affects Europe's climate`
- 주의: 북대서양의 따뜻한 해류. 서유럽 기후를 설명할 때 자주 등장.

### El Niño

- 핵심 의미: 엘니뇨
- 사용 맥락: `El Niño affects global weather patterns`
- 주의: 열대 태평양 해수면 온도 변화와 관련된 기후 현상. 강수와 가뭄 패턴에 영향.

### La Niña

- 핵심 의미: 라니냐
- 사용 맥락: `La Niña conditions`, `La Niña weather patterns`
- 주의: 엘니뇨와 반대되는 경향의 열대 태평양 기후 현상.

### Mount Vesuvius

- 핵심 의미: 베수비오 화산
- 사용 맥락: `the eruption of Mount Vesuvius buried Pompeii`
- 주의: 폼페이를 묻은 화산 폭발로 유명한 이탈리아 화산.

## 기억할 점

- `weathering`은 암석이 제자리에서 부서지는 풍화, `erosion`은 물·바람 등이 깎아 운반하는 침식.
- `sediment`는 퇴적물, `deposition`은 퇴적 과정.
- `latitude`는 위도, `longitude`는 경도, `altitude`는 고도.
- `climate`는 장기적 기후, `weather`는 단기적 날씨.
- `precipitation`은 비·눈·우박 같은 강수, 화학에서는 침전.
- `front`는 기상에서는 기단의 경계, 전쟁에서는 전선.
