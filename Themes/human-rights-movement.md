...
- 주제 범위: 인권, 시민권, 차별과 평등, 사회운동, 시위, 억압과 권리 보호
...
- 핵심 의미: 인권
- 사용 맥락: `human rights violations`, `protect human rights`
- 주의: 국가가 부여한 특권이 아니라, 인간이라는 이유로 보장되어야 하는 기본 권리.
...
- 핵심 의미: 세계인권선언
- 사용 맥락: `the Universal Declaration of Human Rights`
- 주의: 현대 인권 담론의 기본 문서로 자주 언급됨. 약어 `UDHR`.

### Amnesty International

- 핵심 의미: 국제앰네스티
- 사용 맥락: `Amnesty International report`
- 주의: 정치범, 표현의 자유, 고문, 사형제 등 인권 문제를 다루는 국제 NGO.

### Human Rights Watch

- 핵심 의미: 휴먼라이츠워치
- 사용 맥락: `Human Rights Watch documented abuses`
- 주의: 국가와 집단의 인권침해를 조사·보고하는 국제 NGO.

### Nelson Mandela

- 핵심 의미: 넬슨 만델라
- 사용 맥락: `Nelson Mandela fought apartheid`
- 주의: 남아프리카공화국의 반아파르트헤이트 운동과 화해 정치의 상징적 인물.

### Mahatma Gandhi

- 핵심 의미: 마하트마 간디
- 사용 맥락: `Gandhi's nonviolent resistance`
- 주의: 비폭력 저항과 시민 불복종 운동의 대표적 인물.
...
- `equality`는 동등한 대우, `equity`는 조건 차이를 고려한 공정성.
- `discrimination`은 차별 행동, `prejudice`는 편견이나 태도.
- `segregation`은 역사적으로 제도적 인종 분리 맥락이 강함.
- `advocacy`는 단순 지지가 아니라 변화를 위한 공개적 옹호 활동.
- `grassroots`는 위에서 내려온 운동이 아니라 지역·대중 기반 운동.
- `strike`는 군사 타격이 아니라 노동 파업일 수 있음.
- `enfranchise`와 `disenfranchise`는 투표권과 정치적 권리에서 중요함.
