...
- 주제 범위: 문학 일반, 장르와 서사, 시와 극, 문학 비평, 영문학 시대와 주요 작가·작품
...
- 주의: 식민주의의 유산, 언어, 정체성, 권력 관계를 다루는 문학과 비평.
...
- 핵심 의미: 제프리 초서
- 사용 맥락: `Chaucer's Canterbury Tales`
- 주의: 중세 영어 문학의 대표 작가. 다양한 계층의 목소리와 풍자를 보여 줌.

### William Shakespeare

- 핵심 의미: 윌리엄 셰익스피어
- 사용 맥락: `Shakespearean tragedy`, `Shakespeare's sonnets`
- 주의: 영국 르네상스 극문학의 핵심 작가. 비극, 희극, 사극, 소네트 모두 중요함.

### John Milton

- 핵심 의미: 존 밀턴
- 사용 맥락: `Milton's Paradise Lost`
- 주의: 성경적 서사와 정치·종교 사상을 결합한 장편 서사시로 유명함.

### Jane Austen

- 핵심 의미: 제인 오스틴
- 사용 맥락: `Austen's novels of manners`
- 주의: 결혼, 계급, 재산, 여성의 선택을 섬세한 아이러니로 다룸.

### Charles Dickens

- 핵심 의미: 찰스 디킨스
- 사용 맥락: `Dickens and Victorian society`
- 주의: 산업화, 빈곤, 아동 노동, 도시 문제를 다룬 빅토리아 시대 소설가.

### Romantic poets

- 핵심 의미: 영국 낭만주의 시인들
- 사용 맥락: `Wordsworth, Coleridge, Shelley, Keats, and Byron`
- 주의: 자연, 상상력, 감정, 자유, 혁명과 연결된 영문학의 중요한 시인 집단.

### Virginia Woolf

- 핵심 의미: 버지니아 울프
- 사용 맥락: `Woolf's stream of consciousness`
- 주의: 모더니즘 소설, 의식의 흐름, 여성의 글쓰기와 자율성 논의에서 중요함.

### James Joyce

- 핵심 의미: 제임스 조이스
- 사용 맥락: `Joyce's Ulysses`, `modernist experimentation`
- 주의: 의식의 흐름, 언어 실험, 도시와 일상의 서사화로 유명한 모더니즘 작가.

### George Orwell

- 핵심 의미: 조지 오웰
- 사용 맥락: `Orwell's dystopian fiction`, `Orwellian language`
- 주의: 전체주의, 감시, 정치 언어의 조작을 비판한 작가.

### T. S. Eliot

- 핵심 의미: T. S. 엘리엇
- 사용 맥락: `Eliot's The Waste Land`
- 주의: 모더니즘 시, 단편적 형식, 고전·종교·현대 문명의 인용과 연결됨.

## 기억할 점

- `fiction`은 허구 문학, `nonfiction`은 사실 기반 글.
- `prose`는 산문, `verse`는 운문.
- `narrator`는 서술자이고 작가와 같지 않을 수 있음.
- `plot`은 사건 구조, `theme`은 작품의 핵심 문제의식.
- `metaphor`는 은유, `allusion`은 다른 텍스트·신화·역사를 간접적으로 언급하는 표현.
- `criticism`은 문학 비평이라는 뜻이지 단순한 비난만은 아님.
