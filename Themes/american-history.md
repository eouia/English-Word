...
- 주제 범위: 미국의 식민지 시대, 독립과 건국, 헌법 질서, 서부 확장, 노예제와 남북전쟁, 산업화, 대공황, 시민권 운동
...
- 핵심 의미: 견제와 균형
- 사용 맥락: `a system of checks and balances`
- 주의: 입법·행정·사법 권력이 서로를 견제하도록 만든 미국 헌정 원리.
...
- 핵심 의미: 독립선언서
- 사용 맥락: `the Declaration of Independence was adopted in 1776`
- 주의: 미국이 영국으로부터 독립을 선언한 문서. 자연권과 정부의 정당성 논의가 중요함.

### Founding Fathers

- 핵심 의미: 미국 건국의 아버지들
- 사용 맥락: `the Founding Fathers`, `the founders' vision`
- 주의: 워싱턴, 제퍼슨, 매디슨, 해밀턴 등 건국 세대를 가리킴.

### Bill of Rights

- 핵심 의미: 권리장전
- 사용 맥락: `the First Amendment in the Bill of Rights`
- 주의: 미국 헌법의 첫 10개 수정 조항. 표현, 종교, 집회, 형사 절차 권리 등과 연결됨.

### Louisiana Purchase

- 핵심 의미: 루이지애나 매입
- 사용 맥락: `the Louisiana Purchase doubled U.S. territory`
- 주의: 1803년 프랑스로부터 넓은 영토를 사들여 서부 확장의 기반이 됨.

### Manifest Destiny

- 핵심 의미: 명백한 운명
- 사용 맥락: `the ideology of Manifest Destiny`
- 주의: 미국이 대륙 서쪽으로 확장할 운명이라는 19세기 이념. 원주민 축출과 제국주의 비판도 함께 연결됨.

### Trail of Tears

- 핵심 의미: 눈물의 길
- 사용 맥락: `the forced removal known as the Trail of Tears`
- 주의: 체로키 등 원주민이 강제로 이주당한 비극적 사건.

### Civil War

- 핵심 의미: 남북전쟁
- 사용 맥락: `the causes of the Civil War`, `Civil War amendments`
- 주의: 1861-1865년 미국의 내전. 노예제, 주권, 연방 유지 문제가 핵심.

### Emancipation Proclamation

- 핵심 의미: 노예해방선언
- 사용 맥락: `Lincoln issued the Emancipation Proclamation`
- 주의: 링컨이 남부 반란 지역의 노예 해방을 선언한 문서.

### Jim Crow

- 핵심 의미: 짐 크로, 인종분리 제도
- 사용 맥락: `Jim Crow laws`, `the Jim Crow South`
- 주의: 남부에서 흑인의 권리를 제한한 법과 관행을 가리킴.

### New Deal

- 핵심 의미: 뉴딜 정책
- 사용 맥락: `New Deal programs`, `Franklin D. Roosevelt's New Deal`
- 주의: 대공황 대응을 위한 정부 개입, 구호, 회복, 개혁 정책 묶음.

### Pearl Harbor

- 핵심 의미: 진주만
- 사용 맥락: `the attack on Pearl Harbor`
- 주의: 1941년 일본의 공격으로 미국이 제2차 세계대전에 본격 참전하게 된 사건.

### Cold War

- 핵심 의미: 냉전
- 사용 맥락: `Cold War politics`, `Cold War containment`
- 주의: 미국과 소련 중심의 군사·이념·외교 대립.

### Brown v. Board of Education

- 핵심 의미: 공립학교 인종분리 위헌 판결
- 사용 맥락: `Brown v. Board of Education ended legal school segregation`
- 주의: 1954년 연방대법원 판결. 시민권 운동의 핵심 전환점.

### Civil Rights Act

- 핵심 의미: 민권법
- 사용 맥락: `the Civil Rights Act of 1964`
- 주의: 인종, 피부색, 종교, 성별, 출신국가에 따른 차별을 금지한 중요한 연방법.

### Voting Rights Act

- 핵심 의미: 투표권법
- 사용 맥락: `the Voting Rights Act of 1965`
- 주의: 흑인 유권자 등록과 투표를 막던 제도적 장벽을 겨냥한 법.

## 기억할 점

- `colony`는 식민지, `colonial`은 식민지의·식민지 시대의.
- `revolution`은 정당화된 대변혁처럼 쓰일 수 있지만, `rebellion`은 지배 권력에 대한 반란의 느낌이 강함.
- `suffrage`는 참정권. 고통을 뜻하는 `suffering`과 혼동하지 않기.
- `reservation`은 일반적으로 예약이지만, 미국사에서는 원주민 보호구역.
- `trust`는 일반적으로 신뢰지만, 미국 경제사에서는 독점적 기업 결합.
