...
- 주제 범위: 생명체와 세포, 유전과 변이, 진화와 적응, 생태계, 생명공학과 윤리
...
- 핵심 의미: 자연선택
- 사용 맥락: `natural selection favors certain traits`
- 주의: 환경에 더 잘 맞는 형질을 가진 개체가 더 많이 생존·번식하는 과정.
...
- 핵심 의미: 유전공학, 유전자 조작
- 사용 맥락: `genetic engineering of crops`
- 주의: DNA를 인위적으로 바꾸어 원하는 형질을 만들거나 연구하는 기술.
...
- 핵심 의미: 줄기세포
- 사용 맥락: `stem cell research`, `embryonic stem cells`
- 주의: 여러 종류의 세포로 분화할 수 있는 세포. 치료 연구와 윤리 논쟁에서 자주 등장.
...
- 핵심 의미: 진화론과 자연선택의 대표적 과학자
- 사용 맥락: `Darwin's theory of evolution`, `natural selection`
- 주의: 진화, 적응, 생존 경쟁 지문에서 가장 자주 등장.

### Gregor Mendel

- 핵심 의미: 유전 법칙을 정리한 과학자
- 사용 맥락: `Mendel's pea plant experiments`, `Mendelian inheritance`
- 주의: 우성·열성, 형질 전달, 유전 법칙 설명에서 중요함.

### Human Genome Project

- 핵심 의미: 인간 게놈 프로젝트
- 사용 맥락: `the Human Genome Project mapped human DNA`
- 주의: 인간 유전체의 염기서열을 해독한 대규모 과학 프로젝트.

### CRISPR

- 핵심 의미: 유전자 편집 기술
- 사용 맥락: `CRISPR gene editing`, `CRISPR-Cas9`
- 주의: DNA를 비교적 정밀하게 수정하는 기술. 치료 가능성과 윤리 논쟁이 함께 등장함.

### Dolly the sheep

- 핵심 의미: 복제 양 돌리
- 사용 맥락: `Dolly the sheep was cloned`
- 주의: 성체 체세포에서 복제된 대표적 동물 사례.

## 기억할 점

- `species`는 단수와 복수가 같은 형태.
- `inheritance`는 생물학에서는 유전, 법률·재산 맥락에서는 상속.
- `mutation`은 항상 나쁜 변화가 아님. 진화의 재료가 될 수 있음.
- `adaptation`은 생물학에서는 환경에 유리한 형질이나 과정, 문학·영화에서는 각색.
- `immunity`는 생물학에서는 면역, 법률에서는 면책.
