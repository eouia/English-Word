...
- 주제 범위: 농업, 작물 재배, 토양과 관개, 축산업, 생산성, 식량 안보와 지속가능 농업
...
- 핵심 의미: 단일작물 재배
- 사용 맥락: `corn monoculture`, `risks of monoculture`
- 주의: 한 종류 작물만 넓게 재배하면 효율은 높지만 병해와 생태 위험이 커질 수 있음.

### crop rotation

- 핵심 의미: 윤작
- 사용 맥락: `practice crop rotation`
- 주의: 같은 밭에 작물을 바꿔 심어 토양 고갈과 병해를 줄이는 방법.
...
- 핵심 의미: 자급 농업
- 사용 맥락: `subsistence farming communities`
- 주의: 시장 판매보다 가족·지역의 생존에 필요한 식량 생산에 초점.
...
- 핵심 의미: 식량 안보
- 사용 맥락: `global food security`, `threats to food security`
- 주의: 충분하고 안전한 식량에 안정적으로 접근할 수 있는 상태.
...
- 핵심 의미: 지속가능 농업
- 사용 맥락: `sustainable agriculture practices`
- 주의: 생산성, 환경 보전, 토양 건강, 지역사회 지속성을 함께 고려하는 농업.
...
- 핵심 의미: 유전자 변형의
- 사용 맥락: `genetically modified crops`, `GM crops`
- 주의: 특정 형질을 위해 유전자를 조작한 작물이나 생물. 약어 `GM`, `GMO`.
...
- 핵심 의미: 녹색혁명
- 사용 맥락: `the Green Revolution increased crop yields`
- 주의: 고수확 품종, 비료, 관개, 농업 기술 확산으로 식량 생산이 크게 늘어난 20세기 농업 변화.

### Norman Borlaug

- 핵심 의미: 노먼 볼로그
- 사용 맥락: `Norman Borlaug and the Green Revolution`
- 주의: 녹색혁명과 고수확 밀 품종 개발로 자주 언급되는 농학자.

### Dust Bowl

- 핵심 의미: 더스트볼
- 사용 맥락: `the Dust Bowl of the 1930s`
- 주의: 미국 대평원의 심각한 가뭄·토양 침식·농업 붕괴 사례.
...
- 핵심 의미: 세계식량계획
- 사용 맥락: `World Food Programme aid`
- 주의: 기근, 전쟁, 재난 상황에서 식량 지원을 제공하는 국제기구. 약어 `WFP`.

## 기억할 점

- `crop`은 작물과 수확량, `yield`는 수확량·산출량.
- `arable land`는 경작 가능한 땅.
- `fertility`는 토양 비옥도와 출산율 둘 다 가능.
- `irrigation`은 물대기, `drainage`는 배수.
- `livestock`은 가축 전체를 뜻하는 집합명사.
- `pasture`는 방목지, `grazing`은 풀을 뜯는 행위.
- `subsistence farming`은 시장 판매보다 생존을 위한 자급 농업.
