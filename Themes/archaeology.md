...
- 주제 범위: 고고학, 유적과 유물, 발굴, 연대 측정, 고대 문명, 인간 활동의 해석
...
- 핵심 의미: 청동기 시대
- 사용 맥락: `Bronze Age artifacts`, `Bronze Age society`
- 주의: 청동 사용이 중요해진 시대. 지역마다 시기가 다름.

### Iron Age

- 핵심 의미: 철기 시대
- 사용 맥락: `Iron Age fort`, `Iron Age culture`
- 주의: 철 사용과 사회 변화가 연결되는 시대 구분.

### stratigraphy

- 핵심 의미: 층서학, 층위 분석
- 사용 맥락: `archaeological stratigraphy`
- 주의: 아래층이 보통 더 오래되었다는 원리를 바탕으로 상대적 연대를 판단.
...
- 주의: 고대 이집트 문자를 해독하는 데 결정적 단서가 된 유물.

### Pompeii

- 핵심 의미: 폼페이
- 사용 맥락: `the ruins of Pompeii`
- 주의: 화산재에 묻혀 보존된 로마 도시 유적으로, 고대 생활 연구에서 자주 언급됨.

### Tutankhamun

- 핵심 의미: 투탕카멘
- 사용 맥락: `Tutankhamun's tomb`
- 주의: 거의 온전한 무덤 발견으로 유명한 고대 이집트 파라오.
...
- 핵심 의미: 사해문서
- 사용 맥락: `the Dead Sea Scrolls were discovered in caves`
- 주의: 고대 유대교와 성서 연구에 중요한 문서 유물.

### Machu Picchu

- 핵심 의미: 마추픽추
- 사용 맥락: `the Inca site of Machu Picchu`
- 주의: 잉카 문명과 산악 도시 유적을 설명할 때 자주 등장.

## 기억할 점

- `artifact`는 사람이 만든 유물, `fossil`은 생물의 화석.
- `site`는 일반 장소가 아니라 고고학 조사 대상 유적지.
- `context`는 유물이 발견된 위치·층위·동반 자료.
- `stratum`의 복수형은 `strata`.
- `dating`은 연애가 아니라 연대 측정.
- `settlement`는 법적 합의가 아니라 정착지라는 뜻으로 자주 쓰임.
- `conservation`은 환경보전뿐 아니라 유물 보존 처리도 뜻함.
