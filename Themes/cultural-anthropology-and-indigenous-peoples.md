# Cultural Anthropology and Indigenous Peoples

- 주제 범위: 문화인류학, 민족지, 친족과 의례, 토착민·원주민, 식민화, 문화 보존과 권리
...
- 핵심 의미: 민족지, 현지조사 기록
- 사용 맥락: `write an ethnography`, `ethnographic fieldwork`
- 주의: 특정 공동체의 생활, 관습, 의미를 장기간 관찰·기록한 연구 방식과 결과물.
...
- 핵심 의미: 참여관찰
- 사용 맥락: `participant observation in a village`
- 주의: 연구자가 공동체 활동에 참여하면서 관찰하는 인류학의 핵심 방법.
...
- 핵심 의미: 토지·재산 박탈
- 사용 맥락: `Indigenous dispossession`, `land dispossession`
- 주의: 원주민의 토지, 자원, 권리가 빼앗기는 역사적 과정.
...
- 핵심 의미: 토지권
- 사용 맥락: `Indigenous land rights`, `land rights movement`
- 주의: 조상 대대로 살아온 땅에 대한 소유, 사용, 관리, 문화적 권리.
...
- 핵심 의미: 구전 전통
- 사용 맥락: `oral tradition preserves history`
- 주의: 글이 아니라 이야기, 노래, 의례, 기억을 통해 지식과 역사가 전해지는 방식.
...
- 핵심 의미: 유엔 원주민 권리 선언
- 사용 맥락: `UNDRIP recognizes Indigenous rights`
- 주의: `United Nations Declaration on the Rights of Indigenous Peoples`. 원주민 권리 논의의 핵심 문서.

### Iroquois Confederacy

- 핵심 의미: 이로쿼이 연맹
- 사용 맥락: `the Iroquois Confederacy influenced political thought`
- 주의: 북미 원주민 정치 연합체. 자치, 연맹, 의사결정 구조 설명에서 자주 등장.

### Trail of Tears

- 핵심 의미: 눈물의 길
- 사용 맥락: `the Trail of Tears displaced Cherokee people`
- 주의: 미국 원주민 강제 이주와 dispossession의 대표적 역사 사건.

### Dawes Act

- 핵심 의미: 도스법
- 사용 맥락: `the Dawes Act divided tribal lands`
- 주의: 원주민 공동 토지를 개인 소유지로 쪼개며 토지 상실과 동화 정책을 강화한 미국 법.

### Indian Removal Act

- 핵심 의미: 인디언 이주법
- 사용 맥락: `the Indian Removal Act authorized forced relocation`
- 주의: 미국 원주민을 조상 대대로 살던 땅에서 강제로 이주시킨 법.

### Māori

- 핵심 의미: 마오리족
- 사용 맥락: `Māori language revitalization`, `Māori land rights`
- 주의: 뉴질랜드 아오테아로아의 원주민. 토지권, 조약, 언어 부흥 논의에서 자주 등장.

### Treaty of Waitangi

- 핵심 의미: 와이탕이 조약
- 사용 맥락: `the Treaty of Waitangi and Māori rights`
- 주의: 영국 왕실과 마오리 사이의 조약. 해석 차이와 원주민 권리 논의의 핵심.
...
- 핵심 의미: 나바호 네이션
- 사용 맥락: `Navajo Nation sovereignty`
- 주의: 미국 내 큰 원주민 자치 공동체. 주권, 언어, 토지 문제에서 자주 등장.

## 기억할 점

- `culture`는 예술만이 아니라 생활양식과 의미 체계 전체.
- `ethnography`는 민족지 연구와 그 결과물.
- `tribe`는 공식 용어로 쓰이는 맥락도 있지만, 지역과 집단에 따라 조심해야 함.
- `Indigenous`, `Native`, `Aboriginal`, `First Nations`는 지역과 정치 맥락에 따라 적절성이 다름.
- `colonization`, `dispossession`, `assimilation`은 원주민 역사 이해의 핵심어.
- `sovereignty`는 국가만이 아니라 원주민 공동체의 자치권도 뜻함.
- `appropriation`은 문화적 전유·도용 문제와 연결됨.
