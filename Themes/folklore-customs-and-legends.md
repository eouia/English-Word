...
- 주제 범위: 민속, 풍습, 의례, 민간신앙, 구전 전통, 설화와 전설, 신화적 상징과 이야기 구조
...
- 핵심 의미: 동화, 요정 이야기
- 사용 맥락: `Grimm's fairy tales`, `fairy-tale motif`
- 주의: 마법, 변신, 시련, 보상이 자주 등장하는 전통 이야기.
...
- 핵심 의미: 독일 민담을 수집·정리한 형제
- 사용 맥락: `Grimm's fairy tales`, `the Brothers Grimm collection`
- 주의: 유럽 민담, 동화, 구전 전통 연구에서 자주 등장.
...
- 핵심 의미: 영국 전설의 왕
- 사용 맥락: `Arthurian legend`, `King Arthur and the Knights of the Round Table`
- 주의: 역사와 전설이 섞인 영웅 서사의 대표 사례.

### Robin Hood

- 핵심 의미: 영국 민간 전설의 의적
- 사용 맥락: `Robin Hood legend`, `steal from the rich and give to the poor`
- 주의: 민중적 정의, 권력 비판, 영웅 전설의 예로 자주 언급됨.
...
- 핵심 의미: 서아프리카·카리브 민담의 거미 트릭스터
- 사용 맥락: `Anansi stories`, `trickster figure`
- 주의: 꾀와 말솜씨로 강자를 이기는 인물. 구전 전통과 디아스포라 문화에서 중요함.

## 기억할 점

- `myth`는 신화이지만 현대 영어에서는 근거 없는 통념도 뜻함.
- `legend`는 역사적 사실처럼 전해지는 이야기, `folktale`은 민중 사이의 구전 이야기.
- `ritual`은 상징적·반복적 의례, `ceremony`는 공식 행사까지 넓게 씀.
- `customs`는 풍습이라는 뜻도 있지만, 무역·여행 맥락에서는 세관.
- `oral tradition`은 글이 아니라 말, 노래, 공연으로 전승되는 지식 체계.
