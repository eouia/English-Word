...
- 주제 범위: 로마 공화정과 제정, 황제권, 원로원과 시민권, 군단과 정복, 속주 통치, 로마법, 도시·토목, 로마의 쇠퇴와 유산
...
- 핵심 의미: 로마 공화정
- 사용 맥락: `the Roman Republic before the Empire`
- 주의: 원로원, 집정관, 시민권, 귀족·평민 갈등이 중요한 시기.

### Roman Empire

- 핵심 의미: 로마제국
- 사용 맥락: `the expansion of the Roman Empire`
- 주의: 지중해 세계를 장기간 지배한 고대 제국. 서방과 동방의 변화도 중요함.

### Julius Caesar

- 핵심 의미: 율리우스 카이사르
- 사용 맥락: `Julius Caesar crossed the Rubicon`
- 주의: 공화정 말기의 장군·정치가. 독재와 암살, 제정 성립의 배경과 연결됨.
...
- 핵심 의미: 로마의 평화
- 사용 맥락: `the Pax Romana under the early empire`
- 주의: 제국 전성기의 상대적 평화와 안정, 교역 확대를 가리킴.

### Punic Wars

- 핵심 의미: 포에니 전쟁
- 사용 맥락: `Rome and Carthage in the Punic Wars`
- 주의: 로마와 카르타고의 전쟁. 로마가 지중해 강국으로 떠오르는 계기.
...
- 핵심 의미: 비잔티움 제국, 동로마제국
- 사용 맥락: `the Byzantine Empire preserved Roman law`
- 주의: 서방 로마 멸망 후 동방에서 이어진 로마 제국의 후계 체제.

### Twelve Tables

- 핵심 의미: 12표법
- 사용 맥락: `the Twelve Tables of Roman law`
- 주의: 로마 초기 성문법의 상징. 법의 공개와 시민 권리 논의에서 중요함.
...
- 핵심 의미: 밀라노 칙령
- 사용 맥락: `the Edict of Milan granted religious toleration`
- 주의: 313년 기독교를 포함한 종교 관용을 인정한 칙령.

### Fall of Rome

- 핵심 의미: 로마의 몰락
- 사용 맥락: `the Fall of Rome in 476`
- 주의: 보통 476년 서로마 제국의 멸망을 가리킴. 단일 원인보다 여러 요인의 결합으로 설명됨.

## 기억할 점

- `republic`은 공화정, `empire`는 제국. 로마사는 공화정에서 제정으로 넘어가는 흐름이 핵심.
- `senate`는 원로원, `consul`은 집정관. 현대 정치 용어와 뜻이 겹치므로 문맥 확인 필요.
- `province`는 로마 속주, 현대에는 지방·주라는 뜻.
- `legion`은 로마 군단, `legionary`는 군단병.
- `tribute`는 조공이지만, 현대에는 존경의 표시라는 뜻도 강함.
- `pagan`은 고대 다신교를 가리키지만 기독교 중심의 평가적 표현으로 쓰인 역사적 맥락이 있음.
