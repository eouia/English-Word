...
- 주제 범위: 언론과 방송, 디지털 미디어, 대중문화 산업, 팬덤과 유명인, 광고와 플랫폼, 검열과 표현, 문화적 영향
...
- 핵심 의미: 실시간 방송, 생중계하다
- 사용 맥락: `livestream an event`, `livestream audience`
- 주의: 녹화가 아니라 인터넷으로 실시간 송출하는 콘텐츠.

### user-generated content

- 핵심 의미: 사용자 제작 콘텐츠
- 사용 맥락: `user-generated content platforms`
- 주의: 기업이나 전문가가 아니라 일반 사용자가 만든 글, 영상, 이미지, 리뷰.
...
- 핵심 의미: 대중문화
- 사용 맥락: `popular culture and identity`, `pop culture`
- 주의: 많은 사람이 소비하고 공유하는 음악, 영화, 방송, 패션, 게임, 인터넷 문화.
...
- 핵심 의미: 팬덤, 팬 공동체
- 사용 맥락: `online fandom`, `fandom culture`
- 주의: 특정 작품, 인물, 장르를 중심으로 형성된 팬들의 문화와 활동.
...
- 핵심 의미: 인플루언서, 영향력 있는 사람
- 사용 맥락: `social media influencer`, `influencer marketing`
- 주의: 팔로어와 신뢰를 바탕으로 소비와 여론에 영향을 주는 사람.
...
- 핵심 의미: 준사회적
- 사용 맥락: `parasocial relationship`, `parasocial interaction`
- 주의: 시청자나 팬이 유명인·캐릭터와 일방적으로 친밀감을 느끼는 관계.
...
- 핵심 의미: 상품화
- 사용 맥락: `commodification of identity`, `commodification of art`
- 주의: 원래 상품이 아니던 경험, 문화, 정체성, 관계가 사고파는 대상으로 바뀌는 것.
...
- 핵심 의미: 틱톡, 숏폼 영상 플랫폼
- 사용 맥락: `TikTok trends`, `short-form video`
- 주의: 짧은 영상, 알고리즘 추천, 밈 확산, 청소년 문화와 자주 연결됨.

## 기억할 점

- `media`는 매체 전체, `medium`은 단일 매체나 표현 수단.
- `misinformation`은 틀린 정보, `disinformation`은 의도적으로 퍼뜨린 허위 정보.
- `representation`은 미디어 속 재현, 정치에서는 대표·대의.
- `franchise`는 콘텐츠 시리즈 지식재산이기도 하고, 사업 가맹권이기도 함.
- `viral`은 온라인에서 빠르게 퍼지는 현상, 의학에서는 바이러스성.
- `censorship`은 표현 제한, `propaganda`는 인식 조작을 목표로 한 선전.
